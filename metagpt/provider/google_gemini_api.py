...
try:
    ...
    # Skip registration of Gemini provider
...
if HAS_GOOGLE_GENERATIVEAI:
    ...
    # If google-generativeai is not available, log a warning but don't fail
    logger.warning("Google Generative AI is not available due to protobuf version conflicts. Gemini provider will be disabled.")
